...
<html>
<head>
	<title>MyCode School login and signup</title>
	<meta charset="utf-8">
...
<style>
	body{
		overflow-x: hidden; /* DROP THE SCROLL DOWN*/
	}
	#centered1{
		position: absolute;
		font-size: 10vw;
...
<body>
	<div class="row">
		<div class="col-sm-12">
			<div class="well">
				<center><h1 style="color: white;">MyCode School</h1></center>
			</div>
		</div>
	</div>
	<div class="row">
		...
		<div class="col-sm-6" style="left:8%;">
			...
			<h4><strong>join MyCode School Today.</strong></h4>
