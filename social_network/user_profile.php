...
<div class="row">
	...
	<div class="col-sm-12">
		...
		<?php
				...
				if ($row['user_image'] == "") {
					$image = ($row['user_gender'] == "Male") ? 'user_gender_male.jpg' : 'user_gender_female.jpg';
				}
				...
				echo "
					<div class='row'>
						...
						//verifying if a user searched is the same with that user with session started
					...
					if ($content == 'NO' && strlen($upload_image) > 1) {
						...
						echo "
							<div id='own_posts'>
								<div class='row'>
									<div class='col-sm-2'>
										<p><img src='users/$user_image' class='img-circle' width='100' height='100' ></p>
									</div>
									<div class='col-sm-6'>
